CREATE DATABASE  IF NOT EXISTS `testcase` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `testcase`;
-- MySQL dump 10.13  Distrib 5.7.9, for osx10.9 (x86_64)
--
-- Host: 127.0.0.1    Database: testcase
-- ------------------------------------------------------
...
INSERT INTO `project` VALUES ('P0001','my projetc',1);
...
CREATE TABLE `testcase` (
  `id` varchar(10) NOT NULL,
  `testsuite_id` varchar(10) DEFAULT NULL,
...
-- Dump completed on 2016-10-09 22:40:48
